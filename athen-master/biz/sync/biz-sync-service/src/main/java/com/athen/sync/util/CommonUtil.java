...
public class CommonUtil {
    ...
    public static List<Map<String, Object>> getFildCountList(String tableName, String primaryDBType, String secondaryDBType,String dbname, JdbcTemplate jdbcTemplate){
        //查询表字段数量
        ...
        if ("oracle".equalsIgnoreCase(secondaryDBType)) {
            ...
            fildCountSql = "select COLUMN_NAME from information_schema.columns where table_name ='" + tableName + "' and table_schema='"+dbname+"'";
        } else {
