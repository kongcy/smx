...
<#assign css>
    ...
    "manager/drags/css/layoutit.css"]/>
</#assign>
<#assign js>
    <@layout.script ["manager/global/plugins/uniform/jquery.uniform.min.js",
...
<script>
    ...
    $("#resTree").jstree({
        ...
        if(rid){
            $.ajax({
                url:'${Render.url(domain.getManager(), "system/resource/read/")}'+rid,
                type:'GET',
                success:function(data){
                    ...
                    if(methods){
                        ...
                        for(var i=0;i<methods.length;i++){
                            d.push({id:methods[i],text:methods[i]})
                        }
                        select.select2("data",d);
                    }else{
    ...
    $('.btn-delete').click(function(){
        if(rid)
            if(confirm("确认要删除此资源及其下级所有资源吗？"))
                $.ajax({
                    url:'${Render.url(domain.getManager(), "system/resource/delete/")}'+rid,
                    type:'DELETE',
                    success:function(){
    ...
    var queryByPage=function(){
        ...
        $.ajax({
            ...
            cache:true,
            type:"GET",
            url:"${Render.url(domain.getStill(), "manager/global/icon.json")}",
            traditional:true,
            success:function(data){
...
<@layout.main title="资源管理" pageCss="${css}" pageJs="${js}">
<div class="row">
    <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body form">
                        <form id="resourceForm" action="${Render.url(domain.getManager(), "system/resource/save")}" class="form-horizontal form-bordered" method="POST">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">操作&nbsp;<span class="required">*</span></label>

                                    <div class="col-md-10">
                                        <select name="method" multiple="multiple" class="form-control select" style="width: 100%;">
                                            <#list methodTypes as m>
