...
<@layout.main title="热门城市编辑" pageCss="${css}" pageJs="${js}">
<div class="row">
    <div class="col-md-12">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="${Render.url(domain.getManager(), "system/city")}">热门城市</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet box green-haze">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i><#if action =='create'>新建<#else>修改</#if>热门城市
                </div>
            </div>
            <div class="portlet-body form">
                <form action="${Render.url(domain.getManager(), "system/city/${action}")}" class="form-horizontal form-bordered" method="POST" id="userForm">
                            ...
                            <div class="col-md-10">
                                <div class="input-icon right">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="conKey" placeholder="请输入参数" value="${config.conKey}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
