...
import com.xtxk.core.exception.*;
...
public class ManagerGlobalException {
    ...
    public ResultVo ApiServiceException(ApiServiceException e){
        LogUtil.LOG.error(e.getMessage());
        return ResultVo.fail(e.getMessage());
    }

    @ExceptionHandler(FaceEngineServiceException.class)
    public JsonResult FaceEngineServiceException(FaceEngineServiceException e){
        LogUtil.LOG.error(e.getMessage());
        return fail(e.getMessage());
    }
    ...
    public JsonResult BizFeignException(Exception e) {
        LogUtil.LOG.error(e.getMessage());
        return fail(e.getMessage());
    }
    ...
    public JsonResult feignException(FeignException e) {
        LogUtil.LOG.error(e.getMessage());
        return fail(e.getMessage());
    }

    @ExceptionHandler(AuthenticationErrorException.class)
    public JsonResult authenticationErrorException(AuthenticationErrorException e){
        LogUtil.LOG.error(e.getMessage());
        return fail(e.getMessage());
    }
